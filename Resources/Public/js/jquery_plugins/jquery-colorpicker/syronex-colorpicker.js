...
(function($) {
  $.fn.colorPicker = function($$options) {
    ...
    var $defaults = {
      color:new Array(
	"yellow_catheader", "orange_catheader", "red_catheader", "pink_catheader", "default_catheader", "green_catheader",
	"grey_catheader"
	),
      defaultColor: -1,
      columns: 4,
	...
	if($$oldIndex==-1 && o.defaultColor==o.color[i]) $$oldIndex = i;
      ...
      var w = (13+2+2) * (o.columns>0 ? o.columns : o.color.length );
