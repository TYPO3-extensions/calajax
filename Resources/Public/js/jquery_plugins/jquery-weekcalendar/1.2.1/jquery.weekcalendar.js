    ...
    $.widget("ui.weekCalendar", {
        ...
        removeAndAddEvents : function(eventId, events) {
            ...
            for(var i = 0; i < events.length; i++) {
            	var $weekDay = self._findWeekDayForEvent(events[i], self.element.find(".week-calendar-time-slots .day-column-inner"));
	            if($weekDay) {
        ...
        _setupEventCreationForWeekDay : function($weekDay) {
            ...
            $weekDay.mousedown(function(event) {
                ...
                if($target.hasClass("day-column-inner")) {
                    ...
                    $newEvent.css({lineHeight: (options.timeslotHeight) + "px", fontSize: (options.timeslotHeight / 2) + "px"});
        ...
        _renderEvent: function (calEvent, $weekDay) {
            ...
            $calEvent.css({lineHeight: (options.timeslotHeight) + "px", fontSize: (options.timeslotHeight / 2) + "px"});
