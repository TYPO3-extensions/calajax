...
namespace TYPO3\CMS\Calajax\Service;
...
case 'getTSCconf':
	...
	$tx_calajax_pi1 = new \TYPO3\CMS\Calajax\Controller\CalAjax();
	$template		= GeneralUtility::makeInstance('t3lib_tsparser_ext'); // Defined global here!
